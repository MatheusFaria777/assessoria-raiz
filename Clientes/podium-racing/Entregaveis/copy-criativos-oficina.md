# Copy dos criativos — Campanha Oficina (manutenção de carros)

Objetivo: Mensagens (WhatsApp)
CTA de botão sugerido: **Enviar mensagem**
Contato: 51 99651.0092 | @podiumracing
Conta Meta Ads: [preencher — buscar via `/meta-ads-ratos`]

Cada bloco = 1 criativo = 1 anúncio. 3 opções de título (headline) e 3 de descrição do link pra cadastrar como variação no Meta Ads Manager (ele testa sozinho qual combinação performa melhor). O texto principal é único por criativo, com uma variação alternativa de ângulo caso queira testar A/B.

---

### Criativo 1 — Flyer "Oficina Moto e Carro" (itens de revisão)

**Títulos:**
1. Revisão completa pro teu carro
2. Seu carro pede revisão? Chama no zap
3. Manutenção preventiva é economia

**Texto principal (opção A — foco em prevenção):**
Óleo, filtros, freios, suspensão, bateria, correias. Manutenção preventiva evita dor de cabeça (e gasto grande) lá na frente, e o teu carro roda com mais segurança no dia a dia. Manda uma mensagem e agenda teu check-up completo na Podium Racing.

**Texto principal (opção B — foco em urgência/sinal de alerta):**
Carro dando sinal de que precisa de revisão? Não espera virar problema grande. Na Podium Racing você faz o check-up completo, troca de óleo, freios, suspensão e muito mais com quem entende do assunto. Chama no WhatsApp e agenda teu horário.

**Descrições do link:**
1. Check-up completo pro teu carro
2. Segurança e economia em cada detalhe
3. Agenda pelo WhatsApp agora
