...
description: >
  ...
  Salva em [slug]/diagnostico-instagram.html.
...
- **Referência visual HTML:** `estetica-tiara/Entregaveis/diagnostico-instagram.html` — modelo de estrutura e estilo
...
Verificar se existe `[slug]/`. Se existir, **ler todos os arquivos .md da pasta** antes de continuar — não só briefing e contexto. Incluir subpastas como `Transcrições/` se existirem.
...
Gerar um HTML completo seguindo a estrutura e estilo de `estetica-tiara/Entregaveis/diagnostico-instagram.html`.
...
- Referência de CSS do roadmap: ver `estetica-tiara/Entregaveis/diagnostico-instagram.html` (seção `.roadmap`, `.rm-item`, `.rm-dot`, `.rm-tasks`)
...
Salvar em: `[slug]/Entregaveis/diagnostico-instagram.html`
