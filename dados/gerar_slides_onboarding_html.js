...
const NOME_EMPRESA = "Jetor Veículos";
const NOME_RESPONSAVEL = "João";
const CIDADE = "Americana, SP";
const NICHO = "automotivo";
const OUT = "Clientes/jetor-veiculos/Entregaveis/onboard-slides.html";
