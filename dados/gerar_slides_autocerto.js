...
const NOME_EMPRESA = "AutoCerto Multimarcas";
const NOME_RESPONSAVEL = "Douglas";
const CIDADE = "Encantado, RS";
const NICHO = "automotivo";
const OUT = "Clientes/autocerto-multimarcas/Entregaveis/onboard-slides.html";
...
const IMGS_DIR = path.join(__dirname, "../.claude/skills/onboarding/referencias");
...
const slides = [
  ...
  <section class="slide">
    ...
    <div class="grid grid-2">
      ...
      <div class="card">
        <h3>Direcionamento de redes</h3>
        <p>Como se apresentar, o que reforçar, o que faz sentido postar pra aumentar confiança e conversão.</p>
      </div>
    </div>
    <p class="nota">Importante: a gente não produz foto, vídeo ou arte. A gente direciona e usa o que você já tem, ou indica parceiro.</p>
  </section>`,
  ...
  // 10 — 50% do resultado (slide visual de estatística)
  `
  <section class="slide stat-slide">
    <p class="kicker">A métrica que ninguém te conta</p>
    <p class="stat-numero">50%</p>
    <p class="stat-legenda">dos resultados de venda estão relacionados ao <strong>Criativo</strong></p>
  </section>`,

  // 11 — Metade vem do criativo (3 blocos com ícones + frase exata do mentor)
  `
  <section class="slide slide-erro">
    <p class="kicker erro-tag">Metade vem do criativo</p>
    <h2>O que isso muda no dia a dia</h2>
    <div class="grid grid-3">
      <div class="card center">
        <span class="icone-bloco">📱</span>
        <h3>Aparecer nos Stories importa</h3>
        <p>É o ponto de contato direto com quem já te segue. Mostrar bastidor, rotina e o dia a dia do processo aproxima.</p>
      </div>
      <div class="card center">
        <span class="icone-bloco">📢</span>
        <h3>Produzir com frequência fortalece o seu Instagram</h3>
        <p>O algoritmo entende a relevância do seu perfil e te conecta a mais gente nova.</p>
      </div>
      <div class="card center">
        <span class="icone-bloco">🎥</span>
        <h3 class="destaque-texto">Gravar novos anúncios coloca mais dinheiro no seu bolso</h3>
        <p class="destaque-texto">Você está a um anúncio de distância de realizar mais vendas. Anúncios novos possibilitam novos testes e conquistar mais resultados. Falta de anúncio diminui a performance.</p>
      </div>
    </div>
  </section>`,

  // 12 — A outra metade: oferta e comercial (com ícones)
  `
  <section class="slide slide-erro">
    <p class="kicker erro-tag">A outra metade do resultado</p>
    <h2>Oferta e comercial</h2>
    <p class="intro">Tráfego só leva a pessoa até a porta. O que acontece depois que ela bate na porta não é mais sobre o anúncio:</p>
    <div class="grid grid-2">
      <div class="card">
        <span class="icone-bloco">🏷️</span>
        <h3>Oferta</h3>
        <p>Benefício claro definido, solução de dor ou problema, diferencial do produto ou serviço, prova social, simplicidade e coerência.</p>
      </div>
      <div class="card">
        <span class="icone-bloco">🏪</span>
        <h3>Sistema de vendas</h3>
        <p>Página, landing page ou site, WhatsApp, velocidade de resposta, qualidade do atendimento, equipe e processo de vendas.</p>
      </div>
    </div>
    <p class="nota">Por isso a gente faz tantas perguntas antes de sair investindo, pra entender o seu negócio inteiro e montar a estratégia certa.</p>
  </section>`,
  ...
  <section class="slide">
    ...
    <div class="timeline">
      ...
      <div class="timeline-item destaque">
        <span class="timeline-icone">🏁</span>
        <p class="timeline-texto"><strong>Largada</strong> campanhas no ar</p>
      </div>
    </div>
    <p class="nota" style="text-align: center; max-width: none;">Em até 3 dias úteis depois da reunião estratégica, as campanhas já estão no ar.</p>
  </section>`,
